...
geometry_msgs::PoseStamped ToGeometryMsgPoseStamped(int64_t timestamp,
                                                    const std::string& frame_id,
                                                    const Rigid3d& rigid3d) {
  geometry_msgs::PoseStamped pose_stamped;
  pose_stamped.header.stamp =
      ::cartographer_ros::ToRos(carto::common::FromUniversal(timestamp));
...
int main(int argc, char** argv) {
  ...
  ::cartographer_tools::Run(FLAGS_pbstream_filename, FLAGS_bag_filename,
